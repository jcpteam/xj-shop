...
package com.javaboot.common.utils.msg;
...
public class SmsUtils {
    ...
    static final String accessKeyId = "nRxutfOO197y6Rd7";
    static final String accessKeySecret = "UfXaQfCQiqsskK4Apno1y0tkHMIagF";
    ...
    public static SendSmsResponse sendSms(String phone, int code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("JavaBoot");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_144851975");
