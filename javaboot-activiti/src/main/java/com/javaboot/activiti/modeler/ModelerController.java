package com.javaboot.activiti.modeler;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.javaboot.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.javaboot.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
