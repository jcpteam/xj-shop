package com.javaboot.activiti.service;
...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<com.javaboot.activiti.domain.ProcessDefinition> listProcessDefinition(com.javaboot.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.javaboot.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition : processDefinitionList) {
            ...
            com.javaboot.activiti.domain.ProcessDefinition entity = new com.javaboot.activiti.domain.ProcessDefinition();
