        ...
        Keyboard.prototype = {
            ...
            init:function(){
                ...
                var mykeyboard = $('<div class="calculator">\n' +
                    '            <div class="row_line">\n' +
                    '                <span class="num_key" the_val="1">1</span><span class="num_key" the_val="2">2</span><span class="num_key" the_val="3">3</span><span class="btn_key my_exit">关闭</span>\n' +
                    '            </div>\n' +
                    '            <div class="row_line">\n' +
                    ...
                    '            </div>\n' +
                    '            <div class="row_line">\n' +
                    '                <span class="num_key" the_val="7">7</span><span class="num_key" the_val="8">8</span><span class="num_key" the_val="9">9</span><span class="btn_key ok">确定</span>\n' +
                    '            </div>\n' +
                    '            <div class="row_line">\n' +
                ...
                if( this.options ){
                    ...
                    var margin_left = $(this.$element).position().left + 400;
...
//})(jQuery, window, document);
    ...
    exports('mykeyboard',$.fn.mykeyboard);//这一行是自己加的
});