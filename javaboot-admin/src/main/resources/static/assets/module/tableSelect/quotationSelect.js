layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    var MOD_NAME = 'quotationSelect',
        $ = layui.jquery,
        table = layui.table,
        form = layui.form;
    var quotationSelect = function () {
        this.v = '1.1.0';
    };
    ...
    * 初始化表格选择器
    */
    quotationSelect.prototype.render = function (opt) {
        var elem = $(opt.elem);
        ...
        elem.off('click').on('click', function(e) {
            ...
            var tableBox = '<div class="tableSelect layui-anim layui-anim-upbit" style="left:'+l+';top:'+t+';border: 1px solid #d2d2d2;background-color: #fff;box-shadow: 0 2px 4px rgba(0,0,0,.12);padding:10px 10px 0 10px;position: absolute;z-index:66666666;margin: 5px 0;border-radius: 2px;min-width:530px;">';
                ...
                tableBox += '</form>';
                tableBox += '<button style="margin-left: 20px" class="layui-btn layui-btn-sm tableSelect_btn_select">选择<span></span></button>';
                tableBox += '<button style="margin-left: 20px" class="layui-btn layui-btn-sm tableSelect_btn_cancel">取消<span></span></button>';
                tableBox += '</div>';
            ...
            //按钮取消
            tableBox.find('.tableSelect_btn_cancel').on('click', function() {
                tableBox.remove();
            })
    ...
    * 隐藏选择器
    */
    quotationSelect.prototype.hide = function (opt) {
        $('.tableSelect').remove();
    }
    ...
    if(window.top == window.self){
        $(window).scroll(function () {
            quotationSelect.hide();
        });
    }

    exports(MOD_NAME, quotationSelect);
})