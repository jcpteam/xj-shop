        ...
        Class.prototype.components = {
            input: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<div class="layui-input-block">';
                    _html += '<input name="{0}" value="{0}" placeholder="{1}" class="layui-input" lay-vertype="tips" lay-verify="required" {2} {3} {4} style="width:{1}">'
                    .format(json.defaultValue ? json.defaultValue : '', json.width,json.placeholder,_readonly,_disabled,_required);
                    _html += '</div>';
                    // if(selected){
