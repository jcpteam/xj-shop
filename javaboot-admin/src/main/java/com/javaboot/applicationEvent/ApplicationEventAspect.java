...
public class ApplicationEventAspect {
    ...
    @Pointcut("execution(* com.javaboot.web.controller.system.SysLoginController.ajaxLogin(..))")
    public void afterLoginPointcut() {
    }

    @Pointcut("execution(* com.javaboot.quartz.controller.SysJobController.run(..))")
