 ...
 * @date 2021-06-10
 */
public interface StoreGoodsWarehouseAdjustMapper extends BaseMapper<StoreGoodsWarehouseAdjust>
{
    /**
     * 查询商品调拨信息
     * 
     ...
     * 批量删除商品调拨信息
     * 
     * @param adjustIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteStoreGoodsWarehouseAdjustByIds(String[] adjustIds);

    List<StoreGoodsAdjustExportDTO> selectExportGoodsAdjustItemList(StoreGoodsWarehouseAdjust dto);
}
