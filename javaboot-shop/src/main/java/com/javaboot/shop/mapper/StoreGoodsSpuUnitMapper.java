 ...
 * @date 2021-06-20
 */
public interface StoreGoodsSpuUnitMapper {
    /**
     * 查询spu单位
     *
     * @param spuNo spu单位ID
     ...
     * @return 结果
     */
    public int deleteStoreGoodsSpuUnitByIds(String[] spuNos);

    public int selectSpuUnitCountByIds(String[] units);
     ...
     * @return
     */
    List<StoreGoodsSpuUnit> selectUnitAndCoversionByDeptId(String deptId);
}
