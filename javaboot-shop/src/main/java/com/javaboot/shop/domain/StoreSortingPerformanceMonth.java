...
/**
 * 分拣绩效月份对象 store_sorting_performance_month
 * 
 * @author javaboot
 * @date 2021-07-20
 */
public class StoreSortingPerformanceMonth extends BaseEntity{
...
//    @Excel(name = "最后更新时间", width = 30, dateFormat = "yyyy-MM-dd")
    ...
    public String toString() {
        return "StoreSortingPerformanceMonth{" +
                "id=" + id +
                ", userId='" + userId + '\'' +
                ", userName='" + userName + '\'' +
                ", deptId='" + deptId + '\'' +
    ...
    public void setSortingMonth(String sortingMonth){
        this.sortingMonth = sortingMonth;
    }

    public String getSortingMonth(){
        return sortingMonth;
    }
