package com.javaboot.generator.controller;
...
import com.javaboot.common.utils.security.PermissionUtils;
import com.javaboot.generator.domain.GenTable;
import com.javaboot.generator.domain.GenTableColumn;
import com.javaboot.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition" , "attachment; filename=\"javaboot.zip\"");
