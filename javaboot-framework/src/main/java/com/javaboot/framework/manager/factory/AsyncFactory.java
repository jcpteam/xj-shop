package com.javaboot.framework.manager.factory;
...
import com.javaboot.system.domain.CostTime;
import com.javaboot.system.service.ICostTimeService;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.javaboot.common.constant.Constants;
import com.javaboot.common.utils.AddressUtils;
...
import com.javaboot.framework.util.LogUtils;
import com.javaboot.framework.util.ShiroUtils;
import com.javaboot.system.domain.SysLoginLog;
import com.javaboot.system.domain.SysOperLog;
import com.javaboot.system.domain.SysUserOnline;
import com.javaboot.system.service.ISysOperLogService;
import com.javaboot.system.service.ISysUserOnlineService;
import com.javaboot.system.service.impl.SysLoginLogServiceImpl;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message, final Object... args) {
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 插入数据
                SpringUtils.getBean(SysLoginLogServiceImpl.class).insertLoginLog(logininfor);
            }
        };
    }
