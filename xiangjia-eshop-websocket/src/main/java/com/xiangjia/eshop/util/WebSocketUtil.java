package com.xiangjia.eshop.util;
...
public class WebSocketUtil {
    ...
    private static final String WEIGHT_MSG_KEY = "weight" ;
    private static final String CONNECCTION_MSG_KEY = "connection" ;
    ...
    public static void sendWeightMsg(String msg, Set<Session> sessionSet) {
        broadcast(generateMsg(WEIGHT_MSG_KEY, msg), sessionSet);
    }

    public static void sendConnectionMsg(String msg, Set<Session> sessionSet) {
        broadcast(generateMsg(WEIGHT_MSG_KEY, msg), sessionSet);
    }
    ...
    private static void sendMessage(String message, Session session) {
        try {
            ...
            System.out.println("[Socket] websocket-->向客户端发送数据发生异常"+e);
        }
    }
