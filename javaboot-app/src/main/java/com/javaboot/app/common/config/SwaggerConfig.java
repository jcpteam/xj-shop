package com.javaboot.app.common.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 指定当前包路径
                // .apis(RequestHandlerSelectors.basePackage("com.javaboot.web.controller.tool"))
                // .apis(basePackage("com.javaboot.web.controller.system,com.javaboot.web.controller.tool"))
